...
class HourglassModel(BaseModel):
    ...
    def build(self, config):
        ...
        input_size = int(Configuration.get('spectrogram_generation.fft_length', default=1536) / 2 + 1)
        input_shape = (input_size, transformation.size, channels)
        ...
        return Model(inputs=input_initial, outputs=outputs[-1])
